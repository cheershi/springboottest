package com.tnar.mytest.springboottest.gener;
...
public class MyGener {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\workplace\\java_place\\springboottest\\src\\main\\java");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/txq?characterEncoding=utf-8&serverTimezone=GMT%2B8");
        ...
        strategy.setInclude(new String[] { "identity" }); // 需要生成的表
        ...
        pc.setParent("com.tnar.mytest.springboottest");
